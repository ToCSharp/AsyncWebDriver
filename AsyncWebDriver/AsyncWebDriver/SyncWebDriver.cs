...
namespace Zu.AsyncWebDriver.Remote
{
    public class SyncWebDriver                    
    {
        ...
        {
            object res = null; var MRes = new ManualResetEventSlim(true); MRes.Reset();Task.Run(async () => { res = await AsyncDriver.ExecuteScript(script, default(CancellationToken), args); MRes.Set();}); MRes.Wait(); return res;
        }
        ...
        public INavigation Navigate() => AsyncDriver.Navigate();
        ...
        public SyncRemoteTargetLocator SwitchTo() => new SyncRemoteTargetLocator(AsyncDriver.SwitchTo() as RemoteTargetLocator);
