...
namespace Zu.AsyncWebDriver.Interactions
{
    ...
    public class ScrollAction : TouchAction, IAction
    {
        ...
        public ScrollAction(ITouchScreen touchScreen, int offsetX, int offsetY) : this(touchScreen, null, offsetX,
            offsetY)
        {
        }
        ...
        public ScrollAction(ITouchScreen touchScreen, ILocatable actionTarget, int offsetX, int offsetY) : base(
            touchScreen, actionTarget)
        {
